...
and consider the relationship between physical space and digital response.
...
3. Apply feedback loop principles to create meaningful user experiences
...
M2 — Prototype (due Nov 26, 20%)
Working proof-of-concept demonstrating core interaction

M3 — Final Installation (due Dec 10, 50%)
...
- Interaction diagram
- Materials/sensor list
- Reference artists/projects
...
- User Experience & Feedback Loop: 20%
...
- Needs improvement: Concept is underdeveloped or derivative. Weak connection between idea and implementation.

### Technical Execution (30%)
- Excellent: Reliable, responsive system. Clean code. Hardware and software work seamlessly. Handles edge cases.
- Needs improvement: Frequent crashes or unresponsive behavior. Code is disorganized.

### User Experience & Feedback Loop (20%)
- Excellent: Clear, intuitive interaction. Users understand the system without instruction. Feedback loop is evident and well-calibrated.
- Needs improvement: Users are confused. Feedback is delayed, absent, or unclear.

### Documentation & Process (15%)
- Excellent: Thorough process blog. High-quality video and photos. Thoughtful reflection.
- Needs improvement: Minimal documentation. Missing blog posts or video.
...
Buttons: Submit Proposal (M1), Submit Prototype (M2), Submit Final Project (M3)
